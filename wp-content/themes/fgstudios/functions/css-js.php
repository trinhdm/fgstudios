...
function enqueue_js() {
	...
	wp_register_script('classie', get_template_directory_uri() . '/assets/js/classie.js', array( 'jquery' ));
...
$bspath .= "/wp-content/themes/fgs/assets/php/wp_bootstrap_navwalker.php";
