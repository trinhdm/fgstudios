...
<div class="tab-content port__mobile-tablet-display">
  ...
  <div class="tab-pane port--main" id="designs">
    <div class="col-md-12 port--main-design port--main-nav">
      ...
      <div id="design-grid__mobile-tablet">
        <div class="row">
          <?php
          /*
          Query the post
          ...
          */
          ...
          if ( $terms && ! is_wp_error( $terms ) ) :
            ...
            $tax = strtolower($tax_links);
             ...
             /* Insert category name into portfolio-item class */
             echo '<div class="col-md-4 col-sm-6 col-xs-12 portfolio-display design-item '. $tax .'">';
             echo '<a href="'. get_permalink() .'" title="'. get_the_title() .'">';
             echo the_post_thumbnail();
             echo '</a>';
             echo '</div>';
